...
class test_chords(unittest.TestCase):
    ...
    def test_determine_triad(self):
        self.chordsTest(
            [
                [["A minor triad", "C major sixth, second inversion"], ["A", "C", "E"]],
                ...
                [["C major triad"], ["C", "E", "G"]],
                [
                    ["E diminished triad", "G minor sixth, second inversion"],
                    ["E", "G", "Bb"],
                ],
                ...
                [
                    [
                        ...
                        "F suspended second triad, second inversion",
                    ],
                    ["C", "F", "G"],
                ],
                [
                    [
                        ...
                        "C suspended fourth triad, first inversion",
                    ],
                    ["F", "G", "C"],
                ],
                [
                    [
                        ...
                        "G suspended fourth triad, first inversion",
                    ],
                    ["C", "D", "G"],
                ],
                [
                    [
                        ...
                        "C suspended fourth triad, second inversion",
                    ],
                    ["G", "C", "F"],
                ],
            ],
            chords.determine_triad,
            "proper naming",
        )
    ...
    def test_determine_seventh(self):
        self.chordsTest(
            [
                ...
                [
                    ["C minor seventh", "Eb major sixth, third inversion"],
                    ["C", "Eb", "G", "Bb"],
                ],
                ...
                [
                    [
                        ...
                        "A half diminished seventh, second inversion",
                    ],
                    ["Eb", "G", "A", "C"],
                ],
                [
