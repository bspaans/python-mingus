...
python googlecode_upload.py -p mingus -s "mingus-$VERSION - windows installer" -u rhijnauwen --config-dir=/home/bspaans/coding/python/mingus-gc-wiki/ -l Featured /home/bspaans/mingus/dist/mingus-$VERSION.win32.exe

echo
echo "Uploading source distribution"
python googlecode_upload.py -p mingus -s "mingus-$VERSION - source tarball" -u rhijnauwen --config-dir=/home/bspaans/coding/python/mingus-gc-wiki/ -l Featured /home/bspaans/mingus/dist/mingus-$VERSION.tar.gz
